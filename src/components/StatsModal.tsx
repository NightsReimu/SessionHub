    ...
    >
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <button onClick={onClose} className="text-dim hover:text-ink/90 text-xl leading-none">
            ×
          </button>
        </div>
        ...
        <div>
          <div className="text-xs text-dim mb-2">Token 消耗 Top {stats.top_sessions.length}</div>
          <div className="space-y-1">
            {stats.top_sessions.map((s) => (
              ...
              >
                ...
                <span className="truncate text-sm text-ink/90 flex-1">
